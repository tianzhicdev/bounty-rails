...
(206 leads scanned, 28 watchlisted owners covering 167 of them; every lead hand-vetted) — rail split: 111 `crypto_claimed` / 22 `account_rail` / 6 `scam` / 42 `unknown` / 25 `not_a_bounty`.
Data checked 2026-08-30.
